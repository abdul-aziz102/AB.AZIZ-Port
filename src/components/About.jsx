  ...
  return (
    <div className="w-full min-h-screen t  px-6 py-12" id="about">
      ...
      <div className="flex justify-center mt-10">
        <motion.a
          href="/resume.pdf"
          download="Abdul_Aziz_CV.pdf"
          whileHover={{ scale: 1.05, y: -2 }}
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold text-lg shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
        >
